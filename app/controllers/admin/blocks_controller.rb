class Admin::BlocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_block.save
        ...
        format.json { render :show, status: :created, location: @admin_block }
      else
  ...
  def update
    respond_to do |format|
      if @admin_block.update(admin_block_params)
        ...
        format.json { render :show, status: :ok, location: @admin_block }
      else
  ...
  private
    ...
    def admin_block_params
      params.require(:admin_block).permit(:block_address, :hood_id)
    end
end
